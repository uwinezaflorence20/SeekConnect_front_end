                ...
                <div className="sm:flex sm:items-start">
                  <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
                    <svg className="h-6 w-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-10.293a1 1 0 00-1.414-1.414L9 9.586 7.707 8.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">{selectedPerson.FirstName} {selectedPerson.LastName}</h3>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">Email: {selectedPerson.Email}</p>
                      <p className="text-sm text-gray-500">Race: {selectedPerson.Race}</p>
                      <p className="text-sm text-gray-500">Country Of Origin: {selectedPerson.CountryOfOrigin}</p>
                      <p className="text-sm text-gray-500">Age: {selectedPerson.Age}</p>
                      <p className="text-sm text-gray-500">Found Date: {selectedPerson.FoundDate}</p>
                      <p className="text-sm text-gray-500">Comment: {selectedPerson.Comment || '-'}</p>
                    </div>
                  </div>
                </div>
              </div>
